...
from app.commitguard.agents.meeting_record import synthesize_meeting_record
...
from app.commitguard.models.schemas import CandidateKind, Classification, Participant
from app.commitguard.resolvers.combine import resolve_validated_item, resolve_validated_items
...
def test_meeting_record_round_trip():
    ...
    from app.commitguard.models.schemas import MeetingRecord
